...
<!-- <body> -->
<!-- <div class="">
    <button><a href="#myModal" class="" data-toggle="modal">Register</a></button>
</div> -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="homepage.php" method="POST">
                    ...
                    <label for="Birthday">Birthday (MM-DD-YYYY) | (Set as your password)</label>
                    <div class="form-group">
                        <input type="password" name="password" id="birthday" class="form-control" placeholder="Enter your birthday" required="required">
                        <input type="checkbox" id="show-birthday" onclick="showPassword('birthday')"> Show Password
                    </div>
            ...
            <div class="modal-footer">
                <p>Already registered? <a href="#" data-toggle="modal" data-target="#myModal2" data-dismiss="modal">Sign In Here</a></p>
            </div>
        </div>
    </div>
</div>
